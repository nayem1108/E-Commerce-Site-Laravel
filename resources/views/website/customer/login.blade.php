    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
          <form action="{{route('customer-request-login')}}" class="card login-form" method="post">
            @csrf
            <div class="card-body">
              <div class="title">
                <h3>Login Now</h3>
              ...
              <div class="social-login">
                ...
                <pre class="text-center">This section will published soon...</pre>
              </div>
              ...
              <div class="form-group input-group">
                ...
                <span class="text-danger">{{Session::get('email-message')}}</span>
              </div>
              <div class="form-group input-group">
                <label for="reg-fn">Password</label>
                <input class="form-control" type="password" name="password" id="reg-pass" required>
                <span class="text-danger">{{Session::get('password-message')}}</span>
              ...
              <div class="d-flex flex-wrap justify-content-between bottom-content">
                ...
                <a class="lost-pass" href="#" onclick="alert('Function will available soon...')">Forgot password?</a>
              </div>
              <div class="button">
