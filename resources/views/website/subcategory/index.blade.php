        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                <ul class="breadcrumb-nav">
                    ...
                    <li><a href="{{route('category', ['id' => $category->first()->id])}}">{{$category->first()->name}}</a></li>
                                    ...
                                    @foreach ($subcategoryProducts as $subcategoryProduct)
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{asset($subcategoryProduct->image)}}" alt="#"  height="250">
                                                <div class="button">
                                            ...
                                            <div class="product-info">
                                                <span class="category">{{$subcategoryProduct->category->name}} >> {{$subcategoryProduct->subcategory->name}}</span>
                                                <h4 class="title">
                                                    <a href="#">{{$subcategoryProduct->name}}</a>
                                                </h4>
                                                <ul class="review">
                                                ...
                                                <div class="price">
                                                    <span><span>&#2547;.</span> {{$subcategoryProduct->selling_price}} Only</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-product">
                                        <div class="row align-items-center">
                                            <div class="col-md-4 col-12">
                                                <div class="product-image">
                                                    <img src="{{asset($subcategoryProduct->image)}}" alt="#" height="220">
                                                    <div class="button">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-12">
                                                <div class="product-info">
                                                    <span class="category">{{$subcategoryProduct->category->name}}</span>
                                                    <h4 class="title">
                                                        <a href="{{route('product-details-info', ['id' => $subcategoryProduct->id])}}">{{$subcategoryProduct->name}}</a>
                                                    </h4>
                                                    <ul class="review">
                                                        <li><i class="lni lni-star-filled"></i></li>
                                                        <li><i class="lni lni-star-filled"></i></li>
                                                    ...
                                                    <div class="price">
                                                        <span>$ {{$subcategoryProduct->selling_price}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
