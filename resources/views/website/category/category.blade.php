                    ...
                    <div class="single-widget">
                        ...
                        <ul class="list">
                            @foreach ($category->subcategories as $subcategory)
                                <li>
                                    <a href="{{route('subcategory-product', ['id' => $subcategory->id])}}">{{$subcategory->name}} </a>

                                    <span>( {{count($subcategory->allProducts)}} )</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                                    ...
                                    @foreach ($categoryProducts as $product)
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{route('product-details-info', ['id' => $product->id] )}}">{{$product->name}}</a>
                                                </h4>
                                                <ul class="review">
                                                ...
                                                <div class="price">
                                                    <span><span>&#2547;.</span>{{$product->selling_price}}. 00</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="single-product">
                                        <div class="row align-items-center">
                                            <div class="col-lg-4 col-md-4 col-12">
                                                <div class="product-image">
                                                    <img src="{{asset($product->image)}}" alt="{{$product->name}}"  height="250">
                                                    <div class="button">
